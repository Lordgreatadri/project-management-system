...
export default function Edit({auth, errors, task, users, projects}) {
    ...
    const onSubmit = (e) => {
        ...
        post(route("tasks.update", task.data.id));
    }
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight uppercase">Edit Task "{task.data.name}" Record</h2>
                    <Link 
