...
export default function Edit({auth, errors, project}) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight uppercase">Edit Project "{project.name}" Record</h2>
                    <Link 
                        ...
                        className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg" encType="multipart/form-data">
                            {/* <div className="p-3 mt-2 grid gap-1 grid-cols-2 bg-gray-800 text-gray-200">  */}
                                ...
                                <div className='mt-4 p-2 py-2'> 
                                    <InputLabel htmlFor="project_image_path" value="Replace Project Image"/>
